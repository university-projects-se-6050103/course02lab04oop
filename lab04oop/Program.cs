...
namespace lab04oop {
    class Program {
        ...
        static void Main() {
            RunMagazineDemonstation();
            ArrayPerfomanceMeasurer.RunArrayComparisons();
        }

        private static void RunMagazineDemonstation() {
            ...
            magazine.AddArticles(new Article(),
                new Article(new Person("Mykhaylo", "Susla", DateTime.MaxValue), "How to win at chess? 10 simple steps."));
